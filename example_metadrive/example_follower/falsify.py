...
class SpeedSpec(specification_monitor):
    ...
    def __init__(self):
        def spec(sim_result):
            ...
            # FOLLOWER
            follower_speed = sim_result.records.get("follower_speed", [])
            follower_vx = sim_result.records.get("follower_vx", [])
            follower_vy = sim_result.records.get("follower_vy", [])
            follower_heading = sim_result.records.get("follower_heading", [])
            follower_position = sim_result.records.get("follower_position", [])
            
            # values at the end of the sim
            final_follower_speed = follower_speed[-1][-1]
            
            final_follower_vx = follower_vx[-1][-1]
            final_follower_vy = follower_vy[-1][-1]
            
            final_follower_heading = follower_heading[-1][-1]
            final_follower_position = follower_position[-1][-1]
            final_follower_position_x = final_follower_position[0]
            final_follower_position_y = final_follower_position[1]
            ...
            final_data = {
                ...
                "follower_heading": [final_follower_heading],
                "follower_x": [final_follower_position_x],
                "follower_y": [final_follower_position_y],
                "follower_speed": [final_follower_speed],
                "follower_vx": [final_follower_vx],
                "follower_vy": [final_follower_vy],
